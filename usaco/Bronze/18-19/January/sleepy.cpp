...
//Notice that for a cow that is unsorted, you will have to move all the cows before the cow to reach the cow and sort it. Thus answer is just the position of the first cow from the right unsorted.
