...
//total amount of time is small enough (1000) for us to just go through each cow, remove its time, count time covered, and then add that cows time back in.
