...
//set up good variable names

int main(){
	setIO("promote");
	int bronze_before, bronze_after, silver_before, silver_after, gold_before, gold_after, platinum_before, platinum_after;
	read(bronze_before, bronze_after, silver_before, silver_after, gold_before, gold_after, platinum_before, platinum_after);
	int bronze_to_silver = 0, silver_to_gold = 0, gold_to_platinum = 0;
	gold_to_platinum += platinum_after-platinum_before;
	gold_before -= platinum_after-platinum_before;
	silver_to_gold += gold_after-gold_before;
	silver_before -= gold_after-gold_before;
	bronze_to_silver += silver_after-silver_before;
	prints(bronze_to_silver);
	prints(silver_to_gold);
	prints(gold_to_platinum);
	return 0;
}
